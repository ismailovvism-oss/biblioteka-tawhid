...
const DEFAULTS = {
  ...
  noTashkil: true,     /* показывать арабский без огласовок. По умолчанию ВКЛЮЧЕНО:
                          огласовки в Шамиле идут от конкретного издания (одна книга
                          в двух изданиях — 85% и 3,5%), сверить их с печатью мы не
                          можем, и редкие механические сдвиги там встречаются. Данные
                          при этом остаются дословными — снятие только при показе. */
